...
import Utilities._
/** This script takes in an RDD of logs generated by nightly Newman soak test.
  * It has a list of commonly occurring errors that it parses with regex and
  * matches against the file to see their ocurrances
  * Also there is an option to parse for system monitor to see how CPU
  * and memory usage is being handled throughout the program
  *
  */

object RDD_NewmanFilterSoakTest {
