...
/** Finds the degrees of separation between two Marvel comic book characters, based
  ...
  *  Utilizes accumulator which is similar to a tag. We tag a 1 when we find
  *  a hero, we then stop our computation.
  */
object RDD_DegreesOfSeparationBFS {
  ...
  // meaning every node will have access to this accumulator
